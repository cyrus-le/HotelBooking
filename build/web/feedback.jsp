...
<html>
    ...
    <style>
        ...
        .rating>.checked:checked~label:after {
            opacity: 1
        }
    ...
    <body class="bg-light">
        ...
        <div class="container">
            <a href="showorder">Back to the history order</a>
            ...
            <c:if test="${not empty dto}">
                ...
                <p>Orderdetail ID: ${dto.orderDetailID} </p> 
                <p >Hotel ID: ${dto.hotelID} </p> 
                <p >Hotel Name: ${dto.hotelName} </p> 
                <p >Room ID: ${dto.roomID} </p> 
                <p >Quantity: ${dto.quantity} </p> 
                <p >Room Price: ${dto.roomPrice} </p> 
            ...
            <c:if test="${empty feedback}">
                <form method="POST" action="feedback" class="form-group">
                    ...
                    <input type="hidden" name="orderID" value="${requestScope.OrderDetailsDTO.orderID}"/>


                    <h1>Star rating </h1>
                    <div class="rating">
         
                        <input type="radio" name="cboFeedback" value="10" id="10">
            ...
            <c:if test="${not empty feedback}">          
                ...
                <div class="d-flex justify-content-center my-3" >
                    <c:forEach var="i" begin="1" end="10" step="1">
                        <span class="fa fa-star mx-1 <c:if test="${i <= feedback.point}" >checked</c:if> "></span>
                    </c:forEach>
                </div>
