<%-- 
    Document   : verify
    Created on : Dec 9, 2021, 9:58:28 PM
    Author     : Cyrus
--%>
        ...
        <div class="image">
            <div class="container">
                <div class="text">
                    ...
                    <br/>
                    <form action="confirmByEmail" method="POST">
                        <font color='red'>${requestScope.ERROR}</font>
                        <div class="form-group">
                            <h4>Input your code: </h4>
                            <input class="form-control" type="text" name="txtCode" value="" /> <br/>                     
                            <input class="form-control" type="hidden" value="${sessionScope.USER_EMAIL}" name="txtEmail" /> <br/>
